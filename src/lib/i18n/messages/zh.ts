const zh: Record<string, string> = {
  ...
  'ui.install.pageTitle': '安装完整版 DashPersona',
  'ui.install.pageDesc': '安装 CLI 工具，从创作者中心采集真实数据，解锁完整的人设分析功能。',
  ...
  'ui.install.req1': 'Node.js 22 或更高版本',
  'ui.install.req2': 'macOS、Windows 或 Linux',
  'ui.install.req3': 'Google Chrome 浏览器（用于数据采集）',
  'ui.install.stepsHeading': '安装步骤',
  'ui.install.step1Title': '安装 Node.js',
  'ui.install.step1Desc': '前往 nodejs.org 下载并安装最新 LTS 版本。安装后，在终端运行以下命令验证：',
  'ui.install.step1VerifyDesc': '如果安装成功，你会看到版本号（例如 v22.0.0）：',
  'ui.install.step1ImgAlt': '终端显示 node --version 输出',
  'ui.install.step2Title': '安装 Claude Code CLI',
  'ui.install.step2Desc': '在终端运行以下命令全局安装 Claude Code：',
  'ui.install.step2VerifyPre': '安装完成后，运行',
  'ui.install.step2VerifyPost': '验证安装是否成功。',
  'ui.install.step3Title': '安装网页访问技能',
  'ui.install.step3Desc': '安装允许 Claude 采集创作者数据的技能：',
  'ui.install.step4Title': '开启 Chrome 远程调试',
  'ui.install.step4Desc': '数据采集需要连接你的 Chrome 浏览器。按以下步骤操作：',
  'ui.install.step4Sub1Pre': '在 Chrome 中打开',
  'ui.install.step4Sub2Pre': '勾选',
  'ui.install.step4Sub2Post': '选项。',
  'ui.install.step4Sub3': '保持 Chrome 打开，返回此页面。',
  'ui.install.step4ImgAlt': 'Chrome 远程调试设置界面',
  'ui.install.step5Title': '开始采集数据',
  'ui.install.step5Desc': '一切就绪！前往引导页面连接你的账号并开始采集数据。',
  'ui.install.step5Cta': '前往引导页面',
  'ui.install.faqHeading': '常见问题',
  'ui.install.faq1Q': '安装 Claude Code 需要 Anthropic 账号吗？',
  'ui.install.faq1A': '是的，你需要一个 Anthropic 账号来使用 Claude Code。可以在 console.anthropic.com 免费注册。',
  ...
  'ui.install.faq3A': '是的，DashPersona 支持 macOS、Windows 和 Linux。Chrome 远程调试步骤在所有平台上基本相同。',
