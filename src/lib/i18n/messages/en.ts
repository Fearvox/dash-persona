const en: Record<string, string> = {
  ...
  'ui.install.pageTitle': 'Get Started with DashPersona',
  'ui.install.pageDesc': 'Use the DASH Collector desktop app to collect real data from your creator accounts and unlock the full analysis suite.',
  ...
  'ui.install.recommendedHeading': 'Recommended — DASH Collector',
  'ui.install.recommendedDesc': 'Desktop app, one-click install, no terminal setup required.',
  'ui.install.requirementsHeading': 'Requirements',
  'ui.install.req1': 'macOS, Windows, or Linux',
  'ui.install.req2': 'DASH Collector desktop app',
  'ui.install.req3': 'Creator center account (Douyin / TikTok / Red Note)',
  'ui.install.stepsHeading': 'Installation Steps',
  'ui.install.step1Title': 'Download & Install DASH Collector',
  'ui.install.step1Desc': 'Download the version for your operating system and double-click to install.',
  'ui.install.step1DownloadMac': 'Download for macOS',
  'ui.install.step1DownloadWin': 'Download for Windows',
  'ui.install.step1DownloadLinux': 'Download for Linux',
  'ui.install.step2Title': 'Launch & Log In',
  'ui.install.step2Desc': 'After installation, launch DASH Collector and click the tray icon to open the login window. Log in to your creator center (e.g. Douyin Creator Center, TikTok Studio) in the popup browser.',
  'ui.install.step3Title': 'Collect Data from DASH Web',
  'ui.install.step3Desc': 'Once logged in, return to the DashPersona onboarding page, select "Auto Collect" mode, and click the collect button.',
  'ui.install.step3Cta': 'Go to Onboarding',
  'ui.install.cliHeading': 'Alternative — CLI Manual Setup',
  'ui.install.cliDesc': 'If you prefer the command line, you can also install and collect data via CLI.',
  'ui.install.cliToggle': 'Show CLI installation steps',
  'ui.install.cliStep1Title': 'Install Node.js',
  'ui.install.cliStep1Desc': 'Download and install the latest LTS version from nodejs.org.',
  'ui.install.cliStep2Title': 'Install Claude Code CLI',
  'ui.install.cliStep2Desc': 'Run the following command in your terminal to install Claude Code globally:',
  'ui.install.cliStep3Title': 'Install the Web Access Skill',
  'ui.install.cliStep3Desc': 'Install the skill that allows Claude to collect creator data:',
  'ui.install.cliStep4Title': 'Enable Chrome Remote Debugging',
  'ui.install.cliStep4Desc': 'Open chrome://inspect/#remote-debugging in Chrome and enable "Allow remote debugging".',
  'ui.install.faqHeading': 'FAQ',
  'ui.install.faq1Q': 'What is DASH Collector?',
  'ui.install.faq1A': 'DASH Collector is a desktop app with a built-in browser window that helps you log in to creator centers and collect data — no terminal or extra dependencies required.',
  ...
  'ui.install.faq3A': 'Yes, DASH Collector supports macOS, Windows, and Linux.',
  ...
  'ui.components.cdpProxyNotRunning': 'DASH Collector not connected',
  ...
  // Step indicator
  'ui.components.cdpCollectorRecommend': 'Recommended: Use DASH Collector desktop app',
  'ui.components.cdpCollectorRecommendDesc': 'Download DASH Collector for one-click login and data collection — no terminal setup needed.',
  'ui.components.cdpCollectorRecommendLink': 'Download DASH Collector',
  'ui.components.cdpManualSetupTitle': 'Or, set up manually:',
  ...
  'ui.components.cdpStep2Header': 'Step 2 \u2014 Start CDP Proxy (manual)',
  'ui.components.cdpStep2Desc': 'If not using DASH Collector, run this command in your terminal:',
  ...
  // Error recovery
  'ui.components.cdpErrProxyTitle': 'DASH Collector not connected',
  ...
  // Phase status bars
  'ui.components.cdpCheckingProxy': 'Checking DASH Collector connection...',
  'ui.components.cdpProxyNotRunningStatus': 'DASH Collector not connected',
  'ui.components.cdpProxyNotRunningSub': 'Launch the DASH Collector desktop app, or follow the manual steps below.',
  'ui.components.cdpProxyConnected': 'DASH Collector connected',
  'ui.components.cdpVerifyLoginsSub': 'Verify your platform logins before collecting.',
  'ui.components.cdpReadyToCollect': 'DASH Collector connected',
