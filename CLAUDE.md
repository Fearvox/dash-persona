...
## Architecture
- `src/lib/engine/` — 11 analysis modules + stats/ library + signal-collector (18 signals)
...
- `src/lib/textcraft/` — ASCII art rendering engine (fonts, effects, composers, canvas/DOM renderers)
...
- `src/components/ui/` — shared UI (confirm-dialog, toast, textcraft decorators)
